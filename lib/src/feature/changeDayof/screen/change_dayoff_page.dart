...
//         .add(InitializeDayOffStarted(dateRange: "This month"));
//     return BlocConsumer(
...
//                                   InitializeDayOffStarted(dateRange: value));
//                             }
//                           },
//                         ),
//                       ),
...
//                 ),
//                 BlocProvider.of<ChangeDayOffBloc>(context).myDayoff.length == 0
//                     ? Container(
//                         child: Text("No data"),
//                       )
//                     : Expanded(
...
//                           print(mydateRage);
//                           BlocProvider.of<ChangeDayOffBloc>(context).add(
//                               InitializeDayOffStarted(dateRange: mydateRage));
//                         },
//                         onLoading: () {
//                           print("fetch dateRange");
//                           print(mydateRage);
...
//                                               ),
//                                               Text(
//                                                 "${BlocProvider.of<ChangeDayOffBloc>(context).myDayoff[index].date}",
//                                                 style: TextStyle(
//                                                     color: Colors.green,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                 children: [
//                                                   Text(
//                                                     "${BlocProvider.of<ChangeDayOffBloc>(context).myDayoff[index].reason} ",
//                                                     style: TextStyle(
//                                                         color: Colors.red,
//                                                         fontWeight:
//                                                             FontWeight.bold),
...
//             BlocProvider.of<ChangeDayOffBloc>(context).add(
//                 InitializeDayOffStarted(dateRange: "$_startDate/$_endDate"));
//           },
